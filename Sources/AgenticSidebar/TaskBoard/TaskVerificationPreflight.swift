...
///
/// Çözülemeyen depo (`Package.swift` yok, çalıştırılabilir ürün yok) daha
/// önce tam bir ajan koşusu yakıp doğrulamada düşüyordu; bu kapı talebi
/// (claim) geri çekip ertelenmiş bir ret döner, koşu hiç doğmaz. `nil`
/// bağlı değil demektir: eski kompozisyonlar ve testler kapıyı atlar.
