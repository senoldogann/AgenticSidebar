...
/// An exam answer's full solution, rendered as a document instead of chat prose.
///
/// Exam mode answers result-first: the short verdict stays in the transcript as
/// ordinary prose, and the derivation lives here — one sheet with one copy
/// action, the same contract as the plan document.
struct SolutionDocumentView: View {
    let markdown: String
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            // inside a solution is a code block, never a nested sheet.
        ...
        .accessibilityLabel("Solution document")
    }
